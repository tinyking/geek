...
export const SERIES: Series[] = [
  {
    ...
    articles: [
      ...
      { no: "006", date: "2026.08.11", title: "依赖注入：谁在替你的系统兜底？你有没有把人生交给了错误的依赖？", url: "#" },
      { no: "007", date: "2026.08.18", title: "重构 vs 打补丁：有些问题，不是修一下就好了", url: "#" },
      { no: "008", date: "2026.08.25", title: "版本号：你有没有记录过，自己已经升级到了哪个版本？", url: "#" }
    ]
  },
  {
    id: "maboyong-diary",
